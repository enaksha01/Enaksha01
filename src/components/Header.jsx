...
function Header({ isMenuOpen, setIsMenuOpen }) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-gray-100 dark:border-slate-800 shadow-sm px-3 py-2 flex items-center justify-between transition-all duration-300">
      ...
      <div className="flex items-center gap-0.5 active:scale-95 transition-transform duration-200 cursor-pointer min-w-0 flex-shrink -ml-3">
        ...
        <div className="flex flex-col items-center justify-center select-none flex-shrink-0 -ml-4">
          {/* e-Naksha Text Part */}
